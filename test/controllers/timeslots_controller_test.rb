...
class TimeslotsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create timeslot" do
    assert_difference('Timeslot.count') do
      post timeslots_url, params: { timeslot: { date: @timeslot.date, start_at: @timeslot.start_at, user_id: @timeslot.user_id } }
    end
  ...
  test "should update timeslot" do
    patch timeslot_url(@timeslot), params: { timeslot: { date: @timeslot.date, start_at: @timeslot.start_at, user_id: @timeslot.user_id } }
